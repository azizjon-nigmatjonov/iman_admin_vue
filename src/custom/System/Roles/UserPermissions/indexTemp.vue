    ...
    <a-row :gutter="[8]">
      <a-col :span="7">
        <a-card style="height: auto">
          <a-input spellcheck="false" @change="search" placeholder="Поиск ролей" style="padding: 14px" />
        ...
        <a-card style="width: 100%">
          <a-table bordered :columns="columns" :data-source="userPermissions">
            <span slot="create" slot-scope="text">
              <a-switch v-model="text.create"/>
            </span>
            <span slot="read" slot-scope="text">
              <a-switch v-model="text.read"/>
            </span>
            <span slot="update" slot-scope="text">
              <a-switch v-model="text.update"/>
            </span>
            <span slot="delete" slot-scope="text">
              <a-switch v-model="text.delete"/>
            </span>
